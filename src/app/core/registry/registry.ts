  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        title: 'ביצועים ונגישות — מודדים, לא מנחשים',
        blurb: 'idle preloading, @defer prefetch on idle, bundle anatomy, skip-link + landmarks, aria-live, focus management, axe/Lighthouse — Wave 5 Closer.',
        wave: 5,
        status: 'ready',
        loadContent: () =>
          import('../../chapters/ch22-perf-a11y/content').then((m) => m.CH22_CONTENT),
      },
    ],
  },
  {
